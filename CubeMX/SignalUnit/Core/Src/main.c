...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : NRF_CE3_Pin NRF_CSN3_Pin NRF_CE2_Pin NRF_CSN2_Pin
                           LED_RED_Pin */
  GPIO_InitStruct.Pin = NRF_CE3_Pin|NRF_CSN3_Pin|NRF_CE2_Pin|NRF_CSN2_Pin
                          |LED_RED_Pin;
  ...
  /*Configure GPIO pins : NRF_IRQ1_Pin NRF_IRQ3_Pin */
  GPIO_InitStruct.Pin = NRF_IRQ1_Pin|NRF_IRQ3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : PROX_SNSR_Pin SIGNAL_RST_SW_Pin */
  GPIO_InitStruct.Pin = PROX_SNSR_Pin|SIGNAL_RST_SW_Pin;
